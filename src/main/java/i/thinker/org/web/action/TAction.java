...
@Controller(value = "tAction")
@Scope(value = "PROTOTYPE")
@Namespace("/t")
@ParentPackage("XinSD")
public class TAction extends BaseAction implements ModelDriven<T> {
	...
	// 查 查询分页列表数据
	/**
	 * T_getPageBean 查询分页列表数据 parame;int currentPage;int rows;qx对象 {Integer
	...
	public String getPageBean() {
		...
		List<T> list = (List<T>) pageBean.getList();

		for (int i = 0; i < list.size(); i++) {
			StringBuffer buffer = new StringBuffer();
			buffer.append("<a href='#' onclick=\"UpdateTabs('order','/XinSDERP/t/getByModel?t.id="
					+ list.get(i).getId().toString() + "','','iconfont icon-edit');\">编辑</a>&nbsp;&nbsp;");
			buffer.append("<a href='#' onclick=\"Data_Remove('/XinSDERP/t/deleteById?t.id="
	...
	public String getByModel() {
		T model = service.getByModel(t);
		HttpServletRequest request = ServletActionContext.getRequest();
		request.setAttribute("t", model);
		return "success";
	}
	...
	public void setTService(TService service) {
		this.service = service;
	}
