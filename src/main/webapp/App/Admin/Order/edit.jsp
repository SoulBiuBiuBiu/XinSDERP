...
<form id="Context_Submit_From" class="update_from easyui-tabs" action="/XinSDERP/dd/update" data-options="fit:true,border:false,tools:'#Context_Bar',toolPosition:'right'">
	<div title="订单编辑" data-options="closable:false">
		<table>
			<tr>
				<input name="dd.id" id="Context_id" type="hidden" value="${dd.id}">
			...
			<tr>
				<td><input name="time" id="Context_time" class="easyui-datebox" style="width:200px"></td>
			</tr>-->
			<tr>
				<th>客户 <span></span></th>
				<td><input name="dynasty" value="${dd.gk.dw}" type="text" class="easyui-textbox" style="width:400px" data-options="required:false"></td>
				<th>顾客<span></span></th>
				<td> <input id="customerid" name="dd.gk.id" value="${dd.gk.id}" type="hidden" />
					<input id="customername" name="dd.gk.dw" value="${dd.gk.dw}" type="text" class="easyui-textbox" readonly="readonly" style="width:300px">
			...
			<!--<tr>
				<th style="text-align:center;" colspan="4">
					<a class="easyui-linkbutton" href="JavaScript:void(0);" onclick="From_Submit('Book')" data-options="iconCls:'iconfont icon-add'"><span style="font-size:14px; font-weight:600;">æ°å¢</span></a>
				</th>
			</tr>-->
		</table>
		</div>
</form>
<div id="SysCustomerWin" class="easyui-dialog" title="客户选择" data-options="modal:true,closed:true,iconCls:'iconfont icon-account',
